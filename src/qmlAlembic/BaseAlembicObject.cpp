...
{
    QMatrix4x4 qmat(
        static_cast<float>(mat[0][0]), static_cast<float>(mat[1][0]), static_cast<float>(mat[2][0]), static_cast<float>(mat[3][0]),
        static_cast<float>(mat[0][1]), static_cast<float>(mat[1][1]), static_cast<float>(mat[2][1]), static_cast<float>(mat[3][1]),
        static_cast<float>(mat[0][2]), static_cast<float>(mat[1][2]), static_cast<float>(mat[2][2]), static_cast<float>(mat[3][2]),
        static_cast<float>(mat[0][3]), static_cast<float>(mat[1][3]), static_cast<float>(mat[2][3]), static_cast<float>(mat[3][3]));
