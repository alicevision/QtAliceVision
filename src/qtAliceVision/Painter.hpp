...
public:
	 ...
	 */
	Painter(const std::vector<std::string>& layers);
	 ...
	 */
	void drawTriangles(QSGNode* node,
					   const std::string& layer,
					   const std::vector<QPointF>& points,
